...
if(!isset($_SESSION['admin_email'])){
 ...
 <?php
   ...
   if(isset($_GET['edit_product'])){
     ...
     $Prod_MOQ = $row_edit['MOQ'];
     $shipping_price = $row_edit['shipping_price'];
             ...
             <form method="post" class="form-horizontal" enctype="multipart/form-data"><!--form-horizontal Begin --->
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                    ...
                    <p style="color:red;font-weight:bold;font-style:italic;font-size:8px;"> " Plz Use product name with no space for url " </p>
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <br>
                      <img width="70" height="70"src="../seller/product_images/<?php echo $p_img1; ?>" alt="<?php echo $p_img1; ?>">
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <br>
                      <img width="70" height="70"src="../seller/product_images/<?php echo $p_img2; ?>" alt="<?php echo $p_img2; ?>">
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <br>
                      <img width="70" height="70"src="../seller/product_images/<?php echo $p_img3; ?>" alt="<?php echo $p_img3; ?>">
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <input name="pro_moq" type="text" class="form-control" value="<?php echo $Prod_MOQ; ?>">
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <input name="shipping_price" type="text" class="form-control"  value="<?php echo $shipping_price; ?>">
                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <p style="color:red;font-weight:bold;font-style:italic;font-size:8px;"> "Please Insert Your Phone Number" </p>
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
      ...
      move_uploaded_file($temp_name1,"../seller/product_images/$p_img1");
      move_uploaded_file($temp_name2,"../seller/product_images/$p_img2");
      move_uploaded_file($temp_name3,"../seller/product_images/$p_img3");
      ...
      Prod_img3='$p_img3', Prod_price='$p_price', MOQ='$Prod_MOQ', shipping_price='$shipping_price', seller_contact='$seller_contact',Prod_desc='$p_desc',Prod_features='$p_features',Prod_video='$p_video',prod_label='$Prod_label',prod_sale='$Prod_sold' where Prod_id='$p_id'";
      ...
      Prod_price='$p_price', MOQ='$Prod_MOQ', shipping_price='$shipping_price',seller_contact='$seller_contact',Prod_desc='$p_desc',Prod_features='$p_features',Prod_video='$p_video',prod_label='$Prod_label',prod_sale='$Prod_sold' where Prod_id='$p_id'";
