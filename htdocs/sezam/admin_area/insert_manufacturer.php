...
if(!isset($_SESSION['admin_email'])){
         ...
         <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Begin-->
             ...
             <div class="form-group"><!-- form-group 1 Begin-->
                 ...
                 <div class="col-md-6"><!--col-md-6 Begin-->
                   ...
                   <input name="manufacturer_address" type="text" class="form-control">
             ...
             <div class="form-group"><!-- form-group 1 Begin-->
                 ...
                 <div class="col-md-6"><!--col-md-6 Begin-->
                   ...
                   <input name="manufacturer_contact" type="text" class="form-control">
 ...
 <?php
    ...
    if(isset($_POST['submit'])){
      ...
      move_uploaded_file($temp_name,"../seller/images/$manufacturer_logo");



      $insert_manufacturer = "insert into manufacturers (manufacturer_title,manufacturer_address,manufacturer_account,manufacturer_TIN,manufacturer_contact,manufacturer_top,manufacturer_image) values ('$manufacturer_name','$manufacturer_address','$manufacturer_account','$manufacturer_TIN','$manufacturer_contact','$manufacturer_top','$manufacturer_logo')";

      $run_manufacturer = mysqli_query($con,$insert_manufacturer);

      echo "<script>alert('A new Shop has been inserted successfully')</script>";
