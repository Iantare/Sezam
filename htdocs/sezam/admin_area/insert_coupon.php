...
<?php
     if(isset($_POST['submit'])){
       ...
       $get_coupons = "select * from coupons where Prod_id='$coupon_pro_id' or coupon_code='$coupon_code'";
       $run_coupons = mysqli_query($con,$get_coupons);
       $check_coupons = mysqli_num_rows($run_coupons);

       if($check_coupons==1){

          echo "<script>alert('Coupon Code/Product Already Added. PLZ Choose Another Code / Product')</script>";

       }else{

          $insert_coupon = "insert into coupons (Prod_id,coupon_title,coupon_price,coupon_code,coupon_limit,coupon_used)values
