                 ...
                 <div class="form-group"><!--form-group Begin --->
                   ...
                   <div class="col-md-6"><!--col-md-6 Begin --->
                      ...
                      <select name="product_id" class="form-control" required>
                         ...
                         <option> <?php echo $product_title; ?></option>
...
<?php
     if(isset($_POST['update'])){
       ...
       $update_coupon = "update coupons set Prod_id='$coupon_pro_id', coupon_title='$coupon_title', coupon_price='$coupon_price',
                         coupon_code='$coupon_code',coupon_limit='$coupon_limit',coupon_used='$coup_used' where coupon_id='$coup_id'";
